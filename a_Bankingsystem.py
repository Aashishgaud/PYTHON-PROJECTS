...
while(True):
    try : 
        ...
        break
    except AssertionError as a: #it catches exception raise in try block,here AssertionError is inbuilt exception
        print(a)
...
cust=BS.Customer(n,pno,add,pin,acc,bal) #create object from class Customer
    ...
    if x=='N' or x=='n':
        ...
        while(True):#inner loop1/nested while loop
            ...
            if ac==acc and pinn==pin:
                ...
                if c==3:
                    print('You have exceeded number of attempt, please try after some time.')
                    break#exit from inner loop 1
