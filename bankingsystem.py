#Write a program to make banking system develop business logic in one module and call functionality in another .py file

class Customer: #User defined class
    def __init__(self,name,phoneno,address,pin,accno,balance) : #Constructor with multiple arguments declaration
        self._name=name 
        self._pno=phoneno
        self._add=address
        self._pin=pin
